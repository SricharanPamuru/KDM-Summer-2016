...
public class OwlPizza {
    ...
    public OwlPizza() {
        try {
            pm = new DefaultPrefixManager(null, null, "https://www.kdm.com/OWL/sports");
    ...
    public OWLOntology initialzation() throws Exception {
        ...
        ont = manager.createOntology(IRI.create("https://www.kdm.com/OWL/", "sports"));
        OWLClass Pizza = df.getOWLClass(":Sports", pm);
        OWLClass PizzaTopping = df.getOWLClass(":Country", pm);
        OWLClass PizzaBase = df.getOWLClass(":Opponent", pm);
        ...
        OWLClass ThinAndCrisyBase = df.getOWLClass(":Series", pm);
        OWLClass DeepPanBase = df.getOWLClass(":fighting", pm);
        ...
        OWLClass MeatTopping = df.getOWLClass(":play", pm);
        OWLClass VegetableTopping = df.getOWLClass(":result", pm);
        OWLClass CheeseTopping = df.getOWLClass(":win", pm);
        OWLClass SeafoodTopping = df.getOWLClass(":lose", pm);
        ...
        OWLClass SpicyBeefTopping = df.getOWLClass(":ball", pm);
        OWLClass PepperoniTopping = df.getOWLClass(":cup", pm);
        OWLClass SalamiTopping = df.getOWLClass(":sport", pm);
        OWLClass HamTopping = df.getOWLClass(":defeat", pm);
...
*/
        ...
        OWLObjectProperty hasIngredient = df.getOWLObjectProperty(":hasPlayer", pm);
        ...
        OWLObjectProperty hasTopping = df.getOWLObjectProperty(":hasWon", pm);
        ...
        OWLObjectProperty hasBase = df.getOWLObjectProperty(":hasLost", pm);
        ...
        OWLObjectProperty isToppingOf = df.getOWLObjectProperty(":isOpponentOf", pm);
        ...
        OWLObjectProperty isBaseOf = df.getOWLObjectProperty(":isOfCountry", pm);
...
*/
    ...
    public void saveOntology() {
        try {
            ...
            OutputStream os = new FileOutputStream("data/OwlSport.owl");

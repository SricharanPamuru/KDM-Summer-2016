...
public class OwlMovie {
    ...
    public OWLOntology initialzation() throws Exception {
        ...
        OWLClass MovieID = df.getOWLClass(":MovieID", pm);
        OWLDeclarationAxiom declarationAxiom3 = df.getOWLDeclarationAxiom(MovieID);
        ...
        OWLDisjointClassesAxiom disjointClassesAxiom = df.getOWLDisjointClassesAxiom(Movie, Genre, MovieID);
